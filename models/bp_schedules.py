...
class BloodPressureSchedule(Base):
    ...
    # Relationships
    user = relationship("User", back_populates="bp_schedules")
    logs = relationship("BloodPressureLog", back_populates="schedule", cascade="all, delete")

    __table_args__ = (
        CheckConstraint("duration_days > 0", name="check_bp_schedule_positive_duration"),
    )